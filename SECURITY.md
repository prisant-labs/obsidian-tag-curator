...
3. Include the Obsidian version and platform, the Tag Curator version, steps to reproduce, the impact you observed, and any suggested fix.
...
**Out of scope:** cosmetic rendering glitches (please open a normal issue instead), and the behavior of third-party plugins Tag Curator integrates with at runtime (such as Notebook Navigator or Tag Wrangler) - report those to their respective projects.
